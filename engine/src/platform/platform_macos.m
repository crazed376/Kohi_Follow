    ...
    if(mutex) {
        ...
        switch(result) {
            ...
            case EINVAL:
                ...
                break;
            default:
                KERROR("An unhandled error has occurred while destroying a mutex: errno=%i", result);
                break;
        }
...
b8 kmutex_lock(kmutex* mutex) {
    ...
    switch(result) {
        ...
        case EDEADLK:
            ...
            return false;
        default:
            KERROR("An unhandled error has occurred while obtaining a mutex lock: errno=%i", result);
            return false;
    }
}
    ...
    if(mutex->internal_data) {
        ...
        switch(result) {
            ...
            case EPERM:
                ...
                return false;
            default:
                KERROR("An unhandled error has occurred while unlocking a mutex lock: errno=%i", result);
                return false;
        }
    }
...
static void handle_modifier_key(u32 ns_keycode,
                         		u32 ns_key_mask,
                         		u32 ns_l_keycode,
                         		u32 ns_r_keycode,
                         		u32 k_l_keycode,
...
static void  handle_modifier_keys(u32 ns_keycode, u32 modifier_flags) {
    // Shift
    handle_modifier_key(ns_keycode,
