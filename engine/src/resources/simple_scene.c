...
static void simple_scene_actual_unload(simple_scene* scene) {
	...
	if(scene->dir_light) {
		// TODO: If there are resources to unload, that should be done before this next line. Ex: box representating pos/color
	...
	for(u32 i=0; i<p_light_count; ++i) {
		...
		// TODO: If there are resources to unload, that should be done before this next line. Ex: box representing pos/color
