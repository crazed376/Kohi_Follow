...
/**
 * Represents a simple hashtable. Members of this structure should not be modified
 * outside the functions associated with it.
 * 
 * For non-pointer types, table retains a copy of the value. For pointer types, make
 * sure to use the _ptr setter and getter. Table does not take ownership of pointers
 * or associated memory allocations, and should be managed externally.
 * 
 */
...
/**
 * Stores a copy of the data in value in the provided hashtable.
...
/**
 * Stores a pointer as provided in value in the hashtable.
 * Only use for tables wich were created with is_pointer_type = true.
 * 
 * @param table A pointer to the table to get from (Required).
 * @param name The name of the entry to set (Required).
...
/**
 * Obtains a copy of data present in the hashtable.
 * Only use for tables which were *NOT* created with is_pointer_type = true.
 * 
 * @param table A pointer to the table to retrieve from (Required).
...
/**
 * Obtains a pointer to data present in the hashtable.
 ...
 * Useful when non-existant names should return some default value.
